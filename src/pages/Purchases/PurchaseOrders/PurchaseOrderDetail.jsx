        ...
        <div className="container-xxl container-p-y">
            ...
            <div className="card mb-4">
                        ...
                        <div className="col-md-4">
                            <table className="table table-sm mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td className="text-muted">Totaltax</td>
                ...
                <button
                    ...
                    className="px-2 py-1 rounded-lg text-primary border-1 border-primary hover:bg-primary hover:text-white cursor-pointer bg-white"
                    style={{position: "absolute", bottom: 15, right: 15 }}> 
                    <i className="bx bx-download me-1" />Export
                </button>
                                    ...
                                    {modalOptions.length === 0 ? (
                                        ...
                                        <div className="d-flex flex-column gap-2">
                                            {modalOptions.map((s) => (
                                                <label
                                                    key={s}
                                                    className={`d-flex align-items-center gap-3 p-3 rounded border ${selectedStatus === s ? "border-primary bg-label-primary" : "border-light"
                                                        }`}
