...
export default function Profile() {
  ...
  const savePersonal = async (e) => {
    ...
    setSaving(true);
    try {
      const { data } = await api.put("/auth/profile", personal);
      setPersonal(data.user || personal);
  ...
  const savePassword = async (e) => {
    ...
    if (!/[A-Z]/.test(pwd.newPwd))
      errs.newPwd = "Add at least one uppercase letter";
    if (!/[0-9]/.test(pwd.newPwd)) errs.newPwd = "Add at least one number";
    setPwdErrors(errs);
    ...
    <>
      ...
      <div className="container-xxl container-p-y">
        ...
        <div
          ...
          style={{ boxShadow: "0 2px 12px rgba(0,0,0,.08)", borderRadius: 14 }}
        >
          {/* Cover strip */}
          <div
            style={{
          ...
          >
            <div
              style={{
                ...
                inset: 0,
                backgroundImage:
                  "radial-gradient(circle at 20% 80%, rgba(255,255,255,.08) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(255,255,255,.06) 0%, transparent 50%)",
              }}
            />
          </div>
          ...
          <div className="card-body pt-0 pb-4 px-4">
            <div
              className="d-flex align-items-end justify-content-between flex-wrap gap-3"
              style={{ marginTop: -40 }}
            >
              {/* Avatar */}
              <div
                className="position-relative pf-avatar-wrap"
              ...
              >
                ...
                <div
                  className="pf-avatar-overlay rounded-circle d-flex align-items-center justify-content-center"
                  style={{
                    position: "absolute",
                    inset: 4,
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    // Preview or future upload
                    showToast("Avatar selected: " + file.name, "success");
                  }}
                />
              </div>
              ...
              >
                ...
                <p className="text-muted mb-0" style={{ fontSize: 13 }}>
                  ...
                  {personal.department && (
                    <span
                      className="ms-2 badge bg-label-primary"
                      style={{ fontSize: 11 }}
                    >
                      {personal.department}
                    </span>
              ...
              <div className="d-flex gap-2 align-items-center pb-1">
                ...
                >
                  <i className="bx bx-shield-check me-1" />
                  {user?.role || "User"}
                </span>
                <span
              ...
              >
                <div className="card-body p-4">
                  <SectionHead
                    ...
                    subtitle="Update your name, contact and role details"
                  />
                  <form onSubmit={savePersonal}>
                    <div className="row g-3">
                      ...
                      <div className="col-md-6">
                        <Field label="Phone Number">
                          <div className="input-group">
                            ...
                            >
                              <i
                                className="bx bx-phone text-muted"
                                style={{ fontSize: 15 }}
                              />
                            </span>
                            <input
                      ...
                      <div className="col-md-6">
                        <Field
                          label="Role"
                          hint="Assigned by admin — read only"
                        >
                          <input
                          ...
                          <div key={key} className="col-md-6">
                            <Field label={label}>
                              <div className="input-group">
                                ...
                                >
                                  <i
                                    className={`bx ${showPwd[key] ? "bx-hide" : "bx-show"}`}
                                    style={{ fontSize: 15 }}
                                  />
                                </button>
                              </div>
                        ...
                        {pwd.newPwd && (
                          <div className="col-12">
                            ...
                            <div
                              ...
                              style={{ fontSize: 11.5 }}
                            >
                              Use 8+ chars, uppercase, numbers and symbols for a
                              strong password
                            </div>
                          </div>
                        )}
